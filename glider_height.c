...
int main (void) 
{
	...
	double t = 0., t1 = 800. ; /* time interval */
	int status;
/* 
 * Initial conditions 
 */
//loop twentyish times increassing height
	for(int i = 1; i <= 20; i++)
	{
		double y[4] = { 2., 0., 0., 0.1 };
		y[3] += i * 0.25;
		double inheight = y[3];
/*
...
//printf moved outside while loop to get final values
		printf ("% .5e  % .5e  % .5e  % .5e  % .5e\n", t, y[0], y[1], y[2], inheight);
